        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="/index.php?m=Admin&amp;c=Login&amp;a=login" method="post">
                        <ul>
                            ...
                            <li class="user_main_c">
                                <div class="user_main_box">
                                  ...
                                  <input class="TxtUserNameCssClass" id="mg_name" maxlength="20" name="mg_name"> </li></ul>
                                    <ul>
                                        <li class="user_main_text">密&nbsp;&nbsp;&nbsp;&nbsp;码： </li>
                                        <li class="user_main_input">
                                            <input class="TxtPasswordCssClass" id="mg_pwd" name="mg_pwd" type="password">
                                        </li>
                                    </ul>
                                    <ul>
